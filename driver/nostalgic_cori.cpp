 ...
 * Git version: 30dccd7
 * Options:   -o driver/nostalgic_cori.cpp
 * Seed:      4222697664
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_3[8] = {1L,0xC8100C43L,1L,1L,0xC8100C43L,1L,1L,0xC8100C43L};
static struct S0 g_7 = {0xC9A130DFDDAE974CLL,-7L,1,0x1289L,0xFFL,0L,0L,1UL,0x11L};/* VOLATILE GLOBAL g_7 */
...
static struct S0  func_1(void)
{ /* block id: 0 */
    int32_t *l_2[1][8][1] = {{{&g_3[1]},{&g_3[1]},{&g_3[1]},{&g_3[1]},{&g_3[1]},{&g_3[1]},{&g_3[1]},{&g_3[1]}}};
    uint16_t l_4 = 0x0513L;
    int i, j, k;
    l_4++;
    return g_7;
}
