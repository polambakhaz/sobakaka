 ...
 * Git version: 30dccd7
 * Options:   -o driver/jovial_chandrasekhar.cpp
 * Seed:      223644509
 */
...
/* --- GLOBAL VARIABLES --- */
static int32_t g_4 = 0x3AEB5900L;
static int32_t * volatile g_3 = &g_4;/* VOLATILE GLOBAL g_3 */
static struct S1 g_6 = {3301,7,4,0xB6FE6D39L,-11842,-167};/* VOLATILE GLOBAL g_6 */
...
static struct S1  func_1(void)
{ /* block id: 0 */
    const uint32_t l_2 = 0x1860EC01L;
    int32_t *l_5 = &g_4;
    (*g_3) = l_2;
    (*l_5) = (-1L);
    return g_6;
